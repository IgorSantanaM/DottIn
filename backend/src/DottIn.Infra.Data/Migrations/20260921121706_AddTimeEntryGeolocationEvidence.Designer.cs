...
namespace DottIn.Infra.Data.Migrations
{
    ...
    [Migration("20260921121706_AddTimeEntryGeolocationEvidence")]
    partial class AddTimeEntryGeolocationEvidence
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DottIn.Domain.Employees.CompanyJoinLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CompanyJoinLinks", (string)null);
                });
            ...
            modelBuilder.Entity("DottIn.Domain.Exports.DominioEmployeeMapping", b =>
                {
                    ...
                    b.HasIndex("BranchId", "DominioCode")
                        .IsUnique();
            ...
            modelBuilder.Entity("DottIn.Domain.TimeKeepings.TimeKeepingAdjustment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("TimeKeepingAdjustments", null, t =>
                        {
                            t.HasCheckConstraint("CK_TimeKeepingAdjustments_EntryType", "\"EntryType\" IN ('ClockIn', 'BreakStart', 'BreakEnd', 'ClockOut')");

                            t.HasCheckConstraint("CK_TimeKeepingAdjustments_Status", "\"Status\" IN ('Pending', 'Approved', 'Rejected')");
                        });
                });
                    ...
                    b.OwnsMany("DottIn.Domain.TimeKeepings.TimeEntry", "Entries", b1 =>
                        {
                            ...
                            b1.ToTable("TimeEntries", null, t =>
                                {
                                    t.HasCheckConstraint("CK_TimeEntries_Accuracy", "\"AccuracyMeters\" IS NULL OR (\"AccuracyMeters\" > 0 AND \"AccuracyMeters\" <= 100)");

                                    t.HasCheckConstraint("CK_TimeEntries_Location", "(\"Latitude\" IS NULL AND \"Longitude\" IS NULL AND \"AccuracyMeters\" IS NULL AND \"CapturedAtUtc\" IS NULL) OR (\"Latitude\" IS NOT NULL AND \"Longitude\" IS NOT NULL AND \"AccuracyMeters\" IS NOT NULL AND \"CapturedAtUtc\" IS NOT NULL AND \"Latitude\" BETWEEN -90 AND 90 AND \"Longitude\" BETWEEN -180 AND 180)");

                                    t.HasCheckConstraint("CK_TimeEntries_Source", "\"Source\" IN ('Mobile', 'Web', 'Kiosk')");
                                });

                            b1.WithOwner()
                                .HasForeignKey("TimeKeepingId");

                            b1.OwnsOne("DottIn.Domain.Branches.Geolocation", "Location", b2 =>
                                {
                                    b2.Property<int>("TimeEntryId")
                                        .HasColumnType("integer");
                                    ...
                                    b2.HasKey("TimeEntryId");

                                    b2.ToTable("TimeEntries");
            ...
            modelBuilder.Entity("DottIn.Domain.TimeKeepings.TimeKeepingAdjustment", b =>
                {
                    ...
                    b.HasOne("DottIn.Domain.TimeKeepings.TimeKeeping", null)
                        .WithMany()
                        .HasForeignKey("TimeKeepingId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
